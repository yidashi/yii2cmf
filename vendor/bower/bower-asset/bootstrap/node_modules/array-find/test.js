...
test('third callback argument array should be equal to first argument array', function (t) {
  t.plan(3);
  var arr = [1,2,3];
...
test('should throw TypeError if second argument is not a function', function (t) {
  t.plan(1);
  var arr = [1,2,3];
  try {
    find(arr, 'string');
