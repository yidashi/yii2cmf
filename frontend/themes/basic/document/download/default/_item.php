...
<div class="media-body">
    <h4 class="media-heading">
        <a href="<?= Url::to(['document/view', 'id' => $model->id])?>"><?= $model->title?></a>
    ...
    <div class="media-action">
        ...
        <span class="comments"><?= Html::a(Html::icon('comments-o') . '评论' . $model->commentTotal, ['document/view', 'id' => $model->id, '#' => 'comments'])?></span>
    </div>
</div>

<div class="media-right">
    <?php if ($model->cover): ?>
        <a href="<?= Url::to(['document/view', 'id' => $model->id])?>"><?= Html::img($model->cover, ['width' => 160, 'height' => 120]) ?></a>
    <?php endif; ?>
</div>
